...
message("Extracting ASTER GDEM2 elevation data")
...
message("  Loading data with velox")
vx <- velox(aster_dem)
...
message("Extracting Copernicus EU-DEM v1.0 elevation data")
...
message("Extracting Copernicus EU-DEM v1.1 elevation data")
...
message("Extracting IGN elevation data")
